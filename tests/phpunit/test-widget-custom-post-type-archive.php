...
class Test_WP_Custom_Post_Type_Widgets_Archives extends WP_UnitTestCase {
	public $wp_custom_post_type_widgets_archives;
	...
	function constructor() {
		...
		$this->assertStringContainsString( 'A monthly archive of your site&#8217;s Posts.', $this->wp_custom_post_type_widgets_archives->widget_options['description'] );
